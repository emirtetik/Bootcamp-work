...
const productsRange = products.filter(
  (product) => product.unitPrice >= 30 && product.unitPrice <= 100
);
...
for (let i = 1; i < products.length; i++) {
  ...
  if (products[i].unitPrice < cheapProduct.unitPrice) {
    cheapProduct = products[i];
  }
}

console.log(expensiveProduct.name);
console.log(cheapProduct.name);
